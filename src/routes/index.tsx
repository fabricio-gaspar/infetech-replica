    ...
    <SiteShell>
      ...
      <section className="section-y bg-section relative overflow-hidden">
        ...
        <div className="container-x relative text-center reveal max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-[42px] font-black leading-[1.2]">Atendimento em tempo real em todas as soluções<br className="hidden md:block" /> e serviços profissionais de TI</h2>
        </div>
