    ...
    <SiteShell>
      ...
      <section className="section-y bg-section relative overflow-hidden">
        ...
        <div className="container-x relative text-center reveal max-w-6xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-[38px] font-black leading-[1.2] lg:whitespace-nowrap">Atendimento em tempo real em todas as soluções e serviços profissionais de TI</h2>
        </div>
